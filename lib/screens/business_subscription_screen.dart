...
class BusinessSubscriptionScreen
    ...
    return Scaffold(
      ...
      body:
        ...
        builder: (context, snapshot) {
          ...
          final freeSeats =
              data['freeStaffSlots'] ?? 1;

          final extraSeats =
              data['extraStaffSlots'] ?? 0;

          final restrictionMode =
              data['restrictionMode'] ??
                  false;
...
Text(
  ...
  '$activeStaff of $allowedSeats staff seats used',
