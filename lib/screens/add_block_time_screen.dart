...
class AddBlockTimeScreen extends StatefulWidget {
  ...
  @override
  State<AddBlockTimeScreen> createState() => _AddBlockTimeScreenState();
}

class _AddBlockTimeScreenState extends State<AddBlockTimeScreen> {
  ...
  final reasons = ['Lunch', 'Holiday', 'Training', 'Sick', 'Personal'];
  ...
  Future<void> pickStart() async {
    final pickedDate = await showDatePicker(
      ...
      initialDate: dateOnly(startTime),
  ...
  Future<void> pickEnd() async {
    final pickedDate = await showDatePicker(
      ...
      initialDate: dateOnly(endTime),

      firstDate: dateOnly(startTime),
  ...
  Future<void> saveBlock() async {
    ...
    try {
      ...
      final staffName = staffData['name'] ?? 'Team member';
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Block created')));
    } catch (_) {
      if (!mounted) return;
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'We could not save that blocked time. Please try again.',
          ),
        ),
      );
    }
          ...
          children: [
            ...
            Card(
              child: ListTile(
                ...
                subtitle: Text(formatDate(endTime)),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: isSaving || invalidTime ? null : saveBlock,
