...
/// \param jsonDictionary The body of the response.
///
/// \param httpResponse The HTTP URL response containing headers, the status code, etc.
///
///
/// returns:
/// An NSError object with the error information from the JSON response.
+ (NSError * _Nonnull)stp_errorFromStripeResponse:(NSDictionary * _Nullable)jsonDictionary httpResponse:(NSHTTPURLResponse * _Nullable)httpResponse SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly, copy) NSString * _Nullable elementsSessionConfigId;
...
@property (nonatomic, readonly, copy) NSString * _Nullable paymentIntentCreationFlow;
/// The payment method selection for the merchant integration. Can be <code>automatic</code> or <code>merchant_specified</code>
@property (nonatomic, readonly, copy) NSString * _Nullable paymentMethodSelectionFlow;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// The Stripe API request ID, if available. Looks like <code>req_123</code>.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull stripeRequestIDKey;)
+ (NSString * _Nonnull)stripeRequestIDKey SWIFT_WARN_UNUSED_RESULT;
/// The HTTP status code of the failed request as an Int e.g. 400.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull httpStatusCodeKey;)
+ (NSString * _Nonnull)httpStatusCodeKey SWIFT_WARN_UNUSED_RESULT;
...
/// For example, <code>additionalEnabledApplePayNetworks = [.eftpos]</code> enables eftpos Australia.
...
/// Australian users can enable eftpos Australia by adding <code>.eftpos</code> to the <code>additionalEnabledApplePayNetworks</code> list.
///
/// returns:
