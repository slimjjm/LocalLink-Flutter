...
- (void)applePayContext:(STPApplePayContext * _Nonnull)context didSelect:(PKShippingMethod * _Nonnull)shippingMethod completionHandler:(void (^ _Nonnull)(PKPaymentRequestShippingMethodUpdate * _Nonnull))completionHandler;
...
/// @note To maintain privacy, the shipping information is anonymized. For example, in the United States it only includes the city, state, and zip code. This provides enough information to calculate shipping costs, without revealing sensitive information until the user actually approves the purchase.
/// Receive full shipping information in the paymentInformation passed to <code>applePayContext:didCreatePaymentMethod:paymentInformation:</code>
- (void)applePayContext:(STPApplePayContext * _Nonnull)controller didSelectShippingContact:(PKContact * _Nonnull)contact completionHandler:(void (^ _Nonnull)(PKPaymentRequestShippingContactUpdate * _Nonnull))completionHandler;
...
- (void)applePayContext:(STPApplePayContext * _Nonnull)context didChangeCouponCode:(NSString * _Nonnull)couponCode completionHandler:(void (^ _Nonnull)(PKPaymentRequestCouponCodeUpdate * _Nonnull))completionHandler SWIFT_AVAILABILITY(ios,introduced=15.0);
...
- (void)applePayContext:(STPApplePayContext * _Nonnull)context willCompleteWithResult:(PKPaymentAuthorizationResult * _Nonnull)authorizationResult completionHandler:(void (^ _Nonnull)(PKPaymentAuthorizationResult * _Nonnull))completionHandler;
@end
